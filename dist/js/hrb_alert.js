...
function hrb_alert([type, title, text, btn,html], hrb_success, hrb_cancel) {
    var $btns = "", $type = "", $title = "", $text = "", html_hrb_alert = "", $html_content="";
    switch (btn) {
        case 'ok' :
            $btns = '<button class="btn_hrb_alert info">قبول</button>';
            break;
        case 'okCancel' :
            $btns = '<button class="btn_hrb_alert cancel">انصراف</button><button class="btn_hrb_alert info">قبول</button>';
            break;
        case 'sendCancel' :
            $btns = '<button class="btn_hrb_alert cancel">انصراف</button><button class="btn_hrb_alert send submit">ارسال</button>';
            break;
        case 'delCancel' :
            $btns = '<button class="btn_hrb_alert cancel">انصراف</button><button class="btn_hrb_alert del">حذف</button>';
            break;
        case 'cancel' :
            $btns = '<button class="btn_hrb_alert cancel">انصراف</button>';
            break;
        default :
            break;
    }
    ...
    $('.btn_hrb_alert.send , .btn_hrb_alert.info').click(function () {hrb_success();});
